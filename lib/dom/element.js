    ...
    _extend(key) {
        ...
        Node.prototype.classAdd = function (className, notJudge) {
            ...
            if (notJudge) {
                ...
                hasClassReg.test(this.className) ? this.className = this.className.replace(hasClassReg, className) : (this.className += ((this.className[this.className.length - 1] === " ") ? "" : " ") + className);
            }
        }
